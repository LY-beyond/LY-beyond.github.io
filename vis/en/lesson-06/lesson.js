// =========================================================
// lesson-06/lesson.js —— Chapter 6: Flexbox
//   Demos: d-6-1 axis direction / d-6-2 alignment & distribution / d-6-3 flexing
// =========================================================
...
/* ---------------------------------------------------------
 * Demo 6.1 — the main axis and the cross axis
 * ------------------------------------------------------- */
...
/* ---------------------------------------------------------
 * Demo 6.2 — justify-content / align-items
 * ------------------------------------------------------- */
window.DEMOS['d-6-2'] = function (mount) {
  ...
  // Give the boxes different heights so align-items is easy to observe
  stage.innerHTML = ITEMS
...
window.DEMOS['d-6-3'] = function (mount) {
  ...
  function update() {
    ...
    code.textContent =
`/* Leftover space shared in the ratio ${grows.join(' : ')} */
.A { flex-grow: ${grows[0]}; }
.B { flex-grow: ${grows[1]}; }
.C { flex-grow: ${grows[2]}; }`;
  }
