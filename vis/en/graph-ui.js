...
window.KG_UI = {
  ...
  hint: 'Hover to see adjacency · click to select · double-click (or “Expand”) to drill into the next layer · wheel to zoom · drag the background to pan',
  detailEmpty: 'Click any node to see its description and relations here.',
  relationIn: 'Points towards it',
  relationOut: 'Points to',
  noRelation: 'No relations yet',
  btnOpen: 'Open chapter',
  btnDrill: 'Expand',
  btnNoOpen: 'No page for this node',
  listHead: 'Nodes in this view (all clickable)',
  ...
  a11yPicked: 'Selected {name}, {rel} relations',
  a11yView: 'Current view: {title}, {nodes} nodes',
  a11yDrill: 'Expanded the sub-graph of {name}',
};
