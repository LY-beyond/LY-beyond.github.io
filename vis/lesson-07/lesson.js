// =========================================================
// lesson-07/lesson.js —— 第 7 章 Grid 网格布局
//   演示：d-7-1 网格基础 / d-7-2 自动填充 / d-7-3 网格定位
// =========================================================
...
window.DEMOS['d-7-2'] = function (mount) {
  ...
  function update() {
    ...
    info.textContent = `→ 当前自动排成 ${cols} 列`;
