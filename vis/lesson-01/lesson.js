...
window.DEMOS['d-1-1'] = function (mount) {
  const ROWS = [
    { t: '作品集 · 顶部导航', s: '导航栏 · 第 9 章 STEP 3' },
    { t: '作品集 · 首屏 Hero', s: '首屏 · 第 9 章 STEP 4' },
    { t: '作品集 · 作品卡片墙', s: '卡片墙 · 第 9 章 STEP 6' },
    { t: '作品集 · 数据统计区', s: '统计区 · 第 9 章 STEP 7' },
  ];
...
window.DEMOS['d-1-2'] = function (mount) {
  const GROUPS = [
    { name: '基本信息', items: ['姓名 · 李雷', '学号 · 202406', '班级 · 智能科学与技术 1 班'] },
